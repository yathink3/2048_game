...
const Game = ({ CROSS_NUMBER = 4, WINNING_NUMBER = 2048 }: { CROSS_NUMBER?: number; WINNING_NUMBER?: number }) => {
  ...
  return (
    <div className='fixed md:relative flex flex-col min-h-screen min-w-screen justify-evenly items-center border-0 focus:outline-none noselect dark:bg-gray-800'>
